...
function LandingPage() {
  ...
  const [menuPosition, setMenuPosition] = useState({ top: 'auto', bottom: 'auto', left: 'auto', right: 'auto', transform: 'none' });
  ...
  // Smart positioning logic - matches ResultsPage
  useEffect(() => {
    if (showPlusMenu && plusButtonRef.current && menuRef.current) {
      ...
      if (isMobile) {
        ...
        // Horizontal positioning - center on button
          ...
          {selectedOption ? (
            ...
            {showPlusMenu && (
              <div 
                ...
                style={{
                  position: 'fixed',
                  ...(menuPosition.top !== 'auto' && { top: menuPosition.top }),
                  ...(menuPosition.bottom !== 'auto' && { bottom: menuPosition.bottom }),
                  ...(menuPosition.left !== 'auto' && menuPosition.left && { left: menuPosition.left }),
                  ...(menuPosition.right !== 'auto' && menuPosition.right && { right: menuPosition.right }),
                  maxHeight: '60vh',
                  overflowY: 'auto'
                }}
              >
